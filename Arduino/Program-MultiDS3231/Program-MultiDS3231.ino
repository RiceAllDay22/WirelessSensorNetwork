...
void loop() {
  ...
  if (digitalRead(DETACH_PIN) == 1) {
    ...
    tcaselect(0);
    //rtc0.adjust(DateTime(2022, 2, 23, 12, 55, 0));
    tcaselect(1);
    //rtc1.adjust(DateTime(2022, 2, 23, 12, 55, 0));
    tcaselect(2);
    //rtc2.adjust(DateTime(2022, 2, 23, 12, 55, 0));
    tcaselect(3);
    //rtc3.adjust(DateTime(2022, 2, 23, 12, 55, 0));
    delay(5000);
  }
}
