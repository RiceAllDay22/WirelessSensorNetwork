...
class SCD30:
    ...
    def set_automatic_recalibration(self, enable):
        ...
        #self.i2c.writeto_mem(self.addr, self.SET_FRC, data, addrsize=16) #This is the original line, which is an ERROR
    ...
    def __check_crc(self, arr):
        ...
        if self.__crc(arr[0], arr[1]) != arr[2]:
            print('------------------------------------------------------------------------------')
            print('________________ERROR #12: CRC error__________________________________________')
            print('------------------------------------------------------------------------------')
